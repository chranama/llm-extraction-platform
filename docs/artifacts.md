...
`joint_gateway/resilience_latest/` demonstrates bounded local failure behavior
and operator-driven recovery for API, worker, Redis, and Postgres interruption.
