...
def test_global_env_file_survives_compose_subparser() -> None:
    parser = main_mod.build_parser()
    args = parser.parse_args(["--env-override-file", ".env.docker", "compose", "ps"])
    assert args.env_override_file == ".env.docker"
